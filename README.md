...
- [Fashion Class Classification](#2-fashion-class-classification-multi-class-image-classification) (Conv2D Sequential Model)
...
- [Customer Churn Rate Analysis and Minimization](#4-customer-churn-rate-analysis-and-minimization-binary-classification) (Logistic Regression)
- [E-Signing Loan Classification via Finicial History Analysis](#5-e-signing-loan-classification-via-finicial-history-analysis-binary-classification) (Logistic Regression, Random Forest)
- [Credit Card Fraud Detection](#6-credit-card-fraud-detection-binary-classification) (Random Forest, Sequential Model)
